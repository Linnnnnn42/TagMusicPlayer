import { View, Text, StyleSheet, Pressable, Alert, ViewProps } from 'react-native'
...
export const SongsListItem = ({ song }: SongsListItemProps) => {
        ...
        >
            <View style={{ ...styles.songItemContainer }}>
                <View>
                    {song.cover ? (
                        <FastImage
                            source={{ uri: song.cover, priority: FastImage.priority.normal }}
